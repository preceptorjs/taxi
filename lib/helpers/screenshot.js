        ...
        return when(this._execute(stitchingScripts.init), function (initData) {
            ...
            return when(this.takeRawScreenshot(), function (screenshotData) {
                ...
                return when(this._execute(stitchingScripts.revert, [initData]), function () {
                    ...
                    return (Math.abs(image.getWidth() - (initData.viewPortWidth * 2 * devicePixelRatio)) >= 10);
 ...
 * @return {Buffer}
 */
Screenshot.prototype.documentScreenshot = function () {
 ...
 * @return {Buffer}
 */
Screenshot.prototype.viewPortScreenshot = function () {
 ...
 * @return {Buffer}
 */
Screenshot.prototype.areaScreenshot = function (x, y, width, height) {
 ...
 * @private
 */
Screenshot.prototype._takeScreenshot = function (fn) {
        ...
        return when(this.doesNeedStitching(), function (needsStitching) {
            ...
            return when(this.getMaxImageResolution(), function (maxImageResolution) {
                ...
                return when(this._execute(screenshotScripts.init), function (initData) {
                    ...
                    return when(this._takeDocumentScreenshots(documents, initData), function () {
...
Screenshot.prototype._gatherDocumentSections = function (area, initData, maxImageResolution, needsStitching) {
    ...
    for (i = 0; i < sections; i++) {
        ...
        if (needsStitching) {
            document.viewPorts = this._gatherViewPortSections(document, initData);
        } else {
            document.viewPorts = [
                {
                    x: 0,
 ...
 * @private
 */
Screenshot.prototype._gatherViewPortSections = function (document, initData) {
 ...
 * @private
 */
Screenshot.prototype._takeDocumentScreenshots = function (documents, initData) {

    return this.getDriver().utils().map(documents, function (document) {
        return this._takeViewPortScreenshots(document, document.viewPorts, initData);
    }.bind(this));
};
 ...
 * @private
 */
Screenshot.prototype._takeViewPortScreenshots = function (document, viewPorts, initData) {

    return this.getDriver().utils().map(viewPorts, function (viewPort) {
        return this._takeViewPortScreenshot(document, viewPort, initData);
    }.bind(this));
};
 ...
 * @private
 */
Screenshot.prototype._takeViewPortScreenshot = function (document, viewPort, initData) {
...
Screenshot.prototype._stitchImages = function (area, documents, devicePixelRatio) {
    ...
    var image = PNGImage.createImage(area.width * devicePixelRatio * 1.5, area.height * devicePixelRatio);
