...
Screenshot.prototype._takeScreenshot = function (fn, options) {
	...
	return when(devicePixelRatio.getDevicePixelRatio(), function (devicePixelRatio) {

        return when(stitching.doesNeedStitching(), function (needsStitching) {
                ...
                return when(this._execute(screenshotScripts.init), function (initData) {
                    ...
                    return when(this._determineBlockOuts(area, options.context || this, options.blockOuts || [], options.blockOutColor), function (blockOuts) {
						return when(this._takeSectionScreenshots(sections, initData, options), function () {
							...
							var image = this._stitchImages(area, sections, devicePixelRatio);
