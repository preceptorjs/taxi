 ...
 * @param {function} [callBack] Callback function that should be called with each found element
 ...
 * @param {string} selector CSS selector of DOM elements
 * @param {string} text String or sub-string to look for in the elements
 * @param {function} [callBack] Callback function that should be called with each found element
 * @throws {Error} When no element could be found with the given CSS selector.
 * @since 0.2.0
 * @chainable
 ...
 * });
 * ```
 * //TODO: Does it care about casing?
 *
 * ---------------------------------------
 *
 * ##Callback function
...
Chain.prototype.elementType = Chain.prototype.elementSendKeys;
...
Chain.prototype.elementRect = Chain.prototype.elementFrame;
...
Chain.prototype.type = Chain.prototype.sendKeys;
