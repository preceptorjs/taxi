 ...
 * @return {Buffer} Binary image buffer
 */
ActiveWindow.prototype.documentScreenshot = function (options) {
	options = options || {};
 ...
 * @return {Buffer} Binary image buffer
 */
ActiveWindow.prototype.viewPortScreenshot = function (options) {
	options = options || {};
	var screenshot = new Screenshot(this.getDriver());
	options.context = this;
...
/**
 * Takes a screenshot of an area on in the document
 *
 ...
 * @return {Buffer} Binary image buffer
 */
ActiveWindow.prototype.areaScreenshot = function (x, y, width, height, options) {
	options = options || {};
	var screenshot = new Screenshot(this.getDriver());
	options.context = this;
...
ActiveWindow.prototype.saveScreenshot = function (path, options) {
  return when(this.documentScreenshot(options), function (buffer) {
...
ActiveWindow.prototype.compareDocument = function (title, options) {
	...
	return when(this.documentScreenshot(options), function (buffer) {
		var instance = new Comparison(this.getDriver());
		return instance.compare(title, buffer, options.compare);
	}.bind(this));
};
...
ActiveWindow.prototype.compareViewPort = function (title, options) {
	...
	return when(this.viewPortScreenshot(options), function (buffer) {
		var instance = new Comparison(this.getDriver());
		return instance.compare(title, buffer, options.compare);
	}.bind(this));
};
...
ActiveWindow.prototype.compareArea = function (title, x, y, width, height, options) {
	...
	return when(this.areaScreenshot(x, y, width, height, options), function (buffer) {
		var instance = new Comparison(this.getDriver());
		return instance.compare(title, buffer, options.compare);
	}.bind(this));
};
