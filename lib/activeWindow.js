...
ActiveWindow.prototype.getElement = function (selector, selectorType) {
    ...
    return when(this._driver._requestJSON('POST', '/element', {
        using: selectorType || Element.SELECTOR_CSS, value: selector
    }), function (element) {
...
ActiveWindow.prototype.getScrollPosition = function () {
    return this.execute(function () {
        return {
            x: window.pageXOffset || document.body.scrollLeft, y: window.pageYOffset || document.body.scrollTop
        };
    });
};
...
ActiveWindow.prototype.scrollBy = function (x, y) {
    return this.execute(function () {
        window.scrollBy(arguments[0] || 0, arguments[1] || 0);
    }, [x, y]);
};
